...
class DailyTimeTable extends React.Component {
    state = {
        taskList: [{ index: Math.random(), subjectName: "", subLocation: "", startDate: "", endDate: "", startTime: "", endTime: "" }],
        class: '',
        examTitle: '',
        branch: '',
        branchShow: false,
    ...
    handleChange = (e) => {
        if (["subjectName", "subLocation", "startDate", "endDate", "startTime", "endTime"].includes(e.target.name)) {
    ...
    addNewRow = () => {
        this.setState((prevState) => ({
            taskList: [...prevState.taskList, { index: Math.random(), subjectName: "", subLocation: "", startDate: "", endDate: "", startTime: "", endTime: "" }],
        }));
    }
    ...
    handleSubmit = (e) => {
        ...
        console.log(Data);
        Axios.post(process.env.REACT_APP_SECURITY_API.concat("calenderupload"), Data, { headers: { Authorization: Cookies.get("Authorization") } }).then((res) => {
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                <th className="required" >Enter Class Subject</th>
                                                <th className="required" >Enter Location</th>
                                ...
                                <div className="card-footer text-center">
                                    <button type="submit" className="btn btn-primary text-center" style={{width:"200px"}}>Submit</button></div>
                            </div>
                        </div>
                        <div className="col-sm-1"></div>
